      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 24 }}>
        {ME.achievements.map((a, i) => (
          <FadeIn key={a.title} delay={i * 0.1}>
            <div style={{ padding: "32px", border: "1px solid var(--border)", borderRadius: 8, transition: "all 0.3s", position: "relative", overflow: "hidden",height: "100%",display: "flex",flexDirection: "column" }}
